...
$query = "SELECT t.id, t.title, t.description, t.start_dt, t.end_dt, m.name AS member_name, st.name AS stage_name, t.is_done FROM task t
			  ...
			  WHERE t.stage_id = '$stage_id' AND t.project_id = '$project_id' ORDER BY t.id;";
